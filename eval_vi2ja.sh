...
perl $PWD/multi-bleu.pl $PWD/data/evaluation/tmp/truecased/valid.${tgt} < ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/valid_normalize.${tgt} >> ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/valid_result.txt
...
perl $PWD/multi-bleu.pl $PWD/data/evaluation/tmp/truecased/test.${tgt} < ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/test_normalize.${tgt} >> ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/test_result.txt