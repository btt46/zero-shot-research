...
perl $PWD/multi-bleu.pl $PWD/data/evaluation/tmp/normalized/valid.${tgt} < ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/valid_normalize.${tgt} >> ${PWD}/results/${MODEL_NAME}/valid_result.txt
...
perl $PWD/multi-bleu.pl $PWD/data/evaluation/tmp/normalized/test.${tgt} < ${PWD}/results/${MODEL_NAME}/${src}2${tgt}/test_normalize.${tgt} >> ${PWD}/results/${MODEL_NAME}/valid_result.txt