...
fairseq-preprocess -s vi -t en \
			...
			--validpref $BPE_DATA/valid.bpe.en-vi \
			--testpref $BPE_DATA/test.bpe.en-vi \
            --joined-dictionary --srcdict $BIN_DATA/dict.vi.txt --tgtdict $BIN_DATA/dict.en.txt \
			--workers 10 \
...
fairseq-preprocess -s ja -t en \
			...
			--validpref $BPE_DATA/valid.bpe.en-ja \
			--testpref $BPE_DATA/test.bpe.en-ja \
            --joined-dictionary --srcdict $BIN_DATA/dict.ja.txt --tgtdict $BIN_DATA/dict.en.txt \
			--workers 10 \
