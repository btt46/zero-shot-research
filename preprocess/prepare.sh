...
for lang in src; do
    ...
    python3.6 $EXPDIR/preprocess/merge_file.py -i $BPE_DATA/valid.bpe.${lang}.1 $BPE_DATA/valid.bpe.${lang}.3 -o $TAGGED_DATA/valid.${lang}
    ...
    python3.6 $EXPDIR/preprocess/merge_file.py -i $BPE_DATA/test.bpe.${lang}.1 $BPE_DATA/test.bpe.${lang}.3 -o $TAGGED_DATA/test.${lang}
done
