...
cat $BPE_DATA/train.bpe.${lang}.3 | awk 'NR>=489743 && NR <=712850 {print "<2en> " $0}' > $TAGGED_DATA/train.${lang}
...
cat $BPE_DATA/valid.bpe.${lang}.3 | awk 'NR>=3978 && NR <=4848 {print "<2en> " $0}' > $TAGGED_DATA/valid.${lang}
...
cat $BPE_DATA/test.bpe.${lang}.3 | awk 'NR>=3731 && NR <=4924 {print "<2en> " $0}' > $TAGGED_DATA/test.${lang}
